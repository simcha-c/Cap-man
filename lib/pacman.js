...
class Pacman {
  constructor(c, x, y, tile) {
    ...
    this.animationSteps = [100, 80, 20, 80];
  ...
  draw() {
    ...
    var mouthOpen = mouth / 100;
    this.ctx.beginPath();
    this.ctx.arc(this.x + this.xPos, this.y + this.yPos, 13, mouthOpen * 0.2 * Math.PI, (2 - mouthOpen * 0.2) * Math.PI);
